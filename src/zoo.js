...
//  Requerimentos do arquivo data para facilitar a leitura.
const { species } = data;
...
//  Objeto com todos os dias da semana do zoológico.
const daysOfWeek = {
...
//  Caso passado algum parâmetro para day, retornará o dia e o horário aberto apenas no dia, otherwise retornará o objeto daysOfWeek com todos os dias da semana e seus horários.
