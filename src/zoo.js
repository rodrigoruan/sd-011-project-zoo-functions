...
function increasePrices(percentage) {
  ...
  prices.Adult = (Math.round((prices.Adult + (prices.Adult * porcentagem)) * 100)) / 100;
  prices.Child = (Math.round((prices.Child + (prices.Child * porcentagem)) * 100)) / 100;
  prices.Senior = (Math.round((prices.Senior + (prices.Senior * porcentagem)) * 100)) / 100;
  return prices;
}
