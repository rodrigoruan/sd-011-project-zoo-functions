...
function increasePrices(percentage) {
  ...
  data.prices.Child = Math.ceil(data.prices.Child * increase);
  data.prices.Adult = Math.ceil(data.prices.Adult * increase);
  data.prices.Senior = Math.ceil(data.prices.Senior * increase);
  return data.prices;
}
