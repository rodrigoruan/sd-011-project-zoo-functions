...
const increasePrices = (percentage) => Object.keys(prices).forEach((items) => prices[items] *= 1 + (percentage / 100) + 0.00100);
 // Object.keys(prices).forEach((items) => prices[items] = Math.round(prices[items] * 100) / 100);
